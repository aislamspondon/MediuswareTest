...
const CreateProduct = (props) => {
    ...
    let saveProduct = (event) => {
        ...
        axios.post('/product/create/', {
            data: {
                title: title, description: description, slug: slug, variantPrice:productVariantPrices, variants:productVariants
            }
        })
        .then(response => {
                        ...
                        <div className="card shadow mb-4">
                            <div className="card-body">
                                <div className="form-group">
                                    ...
                                    <input type="text" name="title" placeholder="Product Name" className="form-control" value={title}
                                    onChange={(e) => setTitle(e.target.value)}/>
                                </div>
                                <div className="form-group">
                                    <label htmlFor="">Product SKU</label>
                                    <input type="text" name="sku" placeholder="Product Name" className="form-control" value={slug}
                                    onChange={(e) => setSlug(e.target.value)}/>
                                </div>
                                <div className="form-group">
                                    <label htmlFor="">Description</label>
                                    <textarea id="" cols="30" rows="4" className="form-control" name="description" value={description}
                                            ...
                                            productVariantPrices.map((productVariantPrice, index) => {
                                                return (
                                                    <tr key={index}>
                                                        ...
                                                        <td><input className="form-control" type="text"  value={price}
                                                            onChange={(e) => setPrice(e.target.value)} /></td>
                                                        <td><input className="form-control" type="text"  value={stock}
